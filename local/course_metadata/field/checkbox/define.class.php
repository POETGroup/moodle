...
class customfield_define_checkbox extends customfield_define_base {
    ...
    function define_form_specific(&$form) {
        ...
        $form->addElement('selectyesno', 'defaultdata', get_string('defaultchecked', 'local_course_metadata'));
        $form->setDefault('defaultdata', 0); // defaults to 'no'
        $form->setType('defaultdata', PARAM_BOOL);
        $form->addHelpButton('defaultdata', 'customfielddefaultdatacheckbox', 'local_course_metadata');
    }
}
