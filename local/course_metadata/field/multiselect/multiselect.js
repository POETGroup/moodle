  ...
  init : function(Y, args) {
    ...
    $allOptions.each(function(){
        ...
        if ($($this.find('span')).length > 0) {
            ...
            var $makeDefaultLink = $('<a href="#">' + M.util.get_string('defaultmake', 'local_course_metadata') + '</a>');
            ...
            var $unselectLink = $('<a href="#" class="js-hide">' + M.util.get_string('defaultselected', 'local_course_metadata') + '</a>');
