 ...
 */
require_once($CFG->dirroot.'/local/course_metadata/hierarchy/prefix/position/lib.php');
require_once($CFG->dirroot.'/local/course_metadata/core/dialogs/dialog_content.class.php');
